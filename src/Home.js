        ...
        <div className="Home-container">
          ...
          <div id="front-images">
            ...
            <Slider {...settings} id="Slider">
              <div>
                <h3 className="slider-caption">Hot Pot</h3>
                <img className="image"
              ...
              <div>
                <h3 className="slider-caption">Izakaya</h3>
                <img className="image"
              ...
              <div>
                <h3 className="slider-caption">Foodsies</h3>
                <img className="image"
              ...
              <div>
                <h3 className="slider-caption">House Party</h3>
                <img className="image"
              ...
              <div>
                <h3 className="slider-caption">At The Gym</h3>
                <img className="image"
              ...
              <div>
                <h3 className="slider-caption">Safety First</h3>
                <img className="image"
